...
public class ntccproj implements ActionListener
{
    ...
    Label l,l2,l3;
    JPanel jp;
    JLabel l4,l5,l6,l7,l8,l9,l10,l11;
    Button b1, b2,b3,b4,b5,b6,b7,b8,l41;
    public ntccproj()
    {
       
        fi = new Frame("Initializing...Tasker Assistant");
        fi.setSize(800,750);
        fi.setVisible(true);
        ...
        img9=new ImageIcon(getClass().getResource("iconmain.png"));
        Image image9 = img9.getImage(); // transform it 
        Image newimg9 = image9.getScaledInstance(400,400,java.awt.Image.SCALE_SMOOTH); // scale it the smooth way  
        img9 = new ImageIcon(newimg9);
        l11=new JLabel(img9);
        l11.setBounds(150,130,450,450);
        fi.add(l11);   

        fi.setLayout(null);
        fi.setBackground(new Color(255,140,0));
        ...
        img4=new ImageIcon(getClass().getResource("spotify.jpg"));
        ...
        img8=new ImageIcon(getClass().getResource("stock.jpg"));
        Image image8= img8.getImage(); // transform it 
        Image newimg8 = image8.getScaledInstance(55, 56,  java.awt.Image.SCALE_SMOOTH); // scale it the smooth way  
        img8 = new ImageIcon(newimg8);
        l10=new JLabel(img8);
        l10.setBounds(75,305,47,45);
        f.add(l10);
        ...
        f.add(b2);
        b2.setBackground(new Color(245,222,179));
        ...
        f.add(b8);
        b8.setBackground(new Color(255,127,80));
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        else if(e.getSource()==b4)
        {
           try
            {
                Process p = Runtime.getRuntime().exec("python stocks.py");
                BufferedReader reader = new BufferedReader(new InputStreamReader(p.getInputStream()));
                String line = "";
                while ((line = reader.readLine()) != null)
                {
